...
<p>To finish changing your Purplocity account's email address from ${user.email} to ${newEmail}, click the button below.</p>
<a href="${url}" id="verify">Verify Email</a>
<p>Or go to <a href="${url}">${url}</a></p>
<p>You can log into your Purplocity account at <a href="${origin}/pro/">${origin}</a></p>
</div>`,
  });
}
...
<p>To finish creating your Purplocity account, enter this verification code: <span>${user.email_verification_code}</span></p>
<p>If this wasn't you, then you can ignore this email.</p>
<p>You can log into your Purplocity account at <a href="${origin}/pro/">${origin}/pro/</a></p>`,
  });
}
...
<p>Someone requested to change your password on Purplocity. To reset your account password, click the button below.</p>
