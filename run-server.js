...
try {
  ...
  if (err?.code === "ERR_MODULE_NOT_FOUND") {
    console.log(
      "ERROR: You haven't installed dependencies for Purplocity yet, so you can't start the frontend yet."
    );
    console.log(
...
console.log(block("███████████████████████████"));
console.log(
  block("██") + logoBg.black("Purplocity Frontend") + block("██")
);
console.log(block("███████████████████████████"));
...
try {
  ...
  if (
    ...
    console.log(
      no,
      chalk.bold("ERROR:"),
      "You haven't built Purplocity yet, so you can't start the frontend yet."
    );
    console.log(
...
if (!hasTheatreFiles) {
  ...
  console.log(
    " - " +
      chalk.grey("btw theatre files include the entire Purplocity Arcade")
  );
  console.log(
    chalk.grey(
...
server.on("listening", () => {
  ...
  console.log(yes, chalk.bold("Purplocity is running"));
});
